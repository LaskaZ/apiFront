$(document).ready(function () {
    ...
    function getBooks() {
        ...
        $.ajax({
            url: "http://localhost:8080/warsztat5waw4/books"
        }).done(function (books) {
    ...
    function addBooksToHtml(books) {
        ...
        del.on('click', function () {
            ...
            fetch('http://localhost:8080/warsztat5waw4/books/' + idTmp, myInit).then(response => response.json());
    ...
    btnToSend.addEventListener('click', function () {
        ...
        fetch("http://localhost:8080/warsztat5waw4/books", myInit).then(function (response) {
